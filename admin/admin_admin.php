...
elseif($action=='save_admin_edit'){
	...
	if(strlen($admin_password)>60){msg('<span style="color:red">新密码太长,请缩短</span>');}
	if(strlen($admin_nich)>60){msg('<span style="color:red">用户昵称太长,请缩短</span>');}
	if(strlen($admin_admin)>60){msg('<span style="color:red">用户姓名太长,请缩短</span>');}
	if(strlen($admin_mail)>60){msg('<span style="color:red">电子邮箱太长,请缩短</span>');}
	if(strlen($admin_tel)>60){msg('<span style="color:red">联系电话太长,请缩短</span>');}
...
elseif($action=='save_admin'){
	...
	if(strlen($admin_name)>60){msg('<span style="color:red">登录用户名太长,请缩短</span>');}
	if(strlen($admin_password)>60){msg('<span style="color:red">登录用户密码太长,请缩短</span>');}
	if(strlen($admin_nich)>60){msg('<span style="color:red">用户昵称太长,请缩短</span>');}
	if(strlen($admin_admin)>60){msg('<span style="color:red">用户姓名太长,请缩短</span>');}
	if(strlen($admin_mail)>60){msg('<span style="color:red">电子邮箱太长,请缩短</span>');}
	if(strlen($admin_tel)>60){msg('<span style="color:red">联系电话太长,请缩短</span>');}
...
if(!check_purview('admin_group')){msg('<span style="color:red">操作失败,你的权限不足!</span>');}
	...
	if(strlen($admin_group_name)>60){msg('<span style="color:red">管理组名称太长,请缩短</span>');}
	if(strlen($admin_group_info)>60){msg('<span style="color:red">管理组描述太长,请缩短</span>');}
